...
class IntlPhonePicker extends StatefulWidget {
  ...
  @override
  _IntlPhonePickerState createState() => _IntlPhonePickerState();
}

class _IntlPhonePickerState extends State<IntlPhonePicker> {
